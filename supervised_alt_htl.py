...
from pyseg.model.alternative_htl import (SimpleAltHierarchicalTwoLevelState,
SimpleAltHierUtterance, SimpleAltHierarchicalWord)
    ...
    def __init__(self, data, discount, alpha_1, p_boundary, discount_m,
        ...
        if self.sup.boundary_method != 'none': # Boundary supervision
            ...
            for i in range(len_unsegmented):
                ...
                utterance = SupervisedHierUtterance( # TO CHANGE
...
class SimpleAltHierarchicalWord(AltHierarchicalWord):
    ...
    #def __init__(self, sentence, boundaries): #p_segment):
        ...
        #self.seen, if already seen word
